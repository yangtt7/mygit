...
(function (D, aa) {
    ...
    function P(a, b, c) {
        var d, e;
        if (xa(b))r(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (r(b) && Z(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    pb.prototype = {
        dSetter: function () {
            ...
            if (d === 1)c = this.toD; else if (e === b.length && d < 1)for (; e--;)f = parseFloat(a[e]),
    ...
    na = function (a, b) {
        var c;
        if (b === "width")return Math.min(a.offsetWidth, a.scrollWidth) - na(a, "padding-left") - na(a, "padding-right"); else if (b === "height")return Math.min(a.offsetHeight, a.scrollHeight) - na(a, "padding-top") - na(a, "padding-bottom");
    ...
    I = function (a, b, c, d) {
        ...
        e = a.hcEvents;
        var f, g, c = c || {};
        if (A.createEvent && (a.dispatchEvent || a.fireEvent))e = A.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, u(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e); else if (e) {
            e = e[b] || [];
            f = e.length;
    ...
    O.prototype = {
        ...
        css: function (a) {
            ...
            if (e) {
                ...
                if (ya && !fa)M(this.element, a); else {
                    b = function (a, b) {
                    ...
                    function (e) {
                        if (e !== "" || g.length === 1) {
                            ...
                            if (e !== " ") {
                                ...
                                if (n)q.dx = 0; else if (f && j !== null)q.x = j;
                                P(s, q);
                                b.appendChild(s);
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        if (b.offsetWidth > j && /[ \-]/.test(b.textContent || b.innerText))M(b, {
                            ...
                            display: "block",
                            whiteSpace: l || "normal"
                        }), this.hasTextWidth = !0; else if (this.hasTextWidth)M(b, {
                            width: "",
                            display: "",
                            whiteSpace: l || "nowrap"
                        }), this.hasTextWidth = !1;
        ...
        var Bb = {
            Element: K, isIE8: za.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, w = 'angle="' + (90 - Y.atan((m - a) / (n - c)) * 180 / ra) + '"', r(); else {
                ...
                } else if (g.test(a) && b.tagName !== "IMG")f = ma(a), d[c + "-opacitySetter"](f.get("a"), c, b), k = f.get("rgb"); else {
    ...
    Va.prototype = {
        addLabel: function () {
            ...
            if (h)h < 0 && c - i * k < f ? n = B(c / W(h * ja) - f) : h > 0 && c + i * k > e && (n = B((d - c) / W(h * ja))); else if (d = c + (1 - i) * k, c - i * k < f ? l = a.x + l * (1 - i) - f : d > e && (l = e - a.x + l * i, m = -1), l = F(j, l), l < j && b.labelAlign === "center" && (a.x += m * (j - l - i * (j - F(k, l)))), k > l || b.autoRotation && g.styles.width)n = l;
            if (n) {
                q.width = n;
    ...
    ha.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            if (h)g = Ka(h, this); else if (c)g = b; else if (d)g = Qa(d, b); else if (f && a >= 1E3)for (; f-- && g === y;)c = Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = x.numberFormat(b / c, -1) + e[f]);
        ...
        setTickInterval: function (a) {
            ...
            if (z && r(b.dataMin))if (q = q || 0, !r(w) && b.min < q && b.dataMin >= q)b.min = q; else if (!r(v) && b.max > q && b.dataMax <= q)b.max = q;
        ...
        renderUnsquish: function () {
            ...
            }), m > h && m > k.h ? i.rotation = this.labelRotation : this.labelRotation = 0; else if (g && (l = {width: h + "px"}, !j)) {
                l.textOverflow = "clip";
    ...
    ha.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = B(a), i = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = V(b), k, j, l, m, n, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !n; f++) {
            j = e.length;
    ...
    Ob.prototype =
    {
        ...
        var d = this.chart, e = this.distance, f = {}, g = c.h || 0, h, i = ["y", d.chartHeight, b, c.plotY + d.plotTop, d.plotTop, d.plotTop + d.plotHeight], k = ["x", d.chartWidth, a, c.plotX + d.plotLeft, d.plotLeft, d.plotLeft + d.plotWidth], j = !this.followPointer && o(c.ttBelow, !d.inverted === !!c.negative), l = function (a, b, c, d, h, i) {
            ...
            d += e;
            if (j && m)f[a] = d; else if (!j && k)f[a] = l; else if (k)f[a] = F(i - c, l - g < 0 ? l : l - g); else if (m)f[a] = t(h, d + g + c > b ? d :
            d + g); else return !1
        }, m = function (a, b, c, d) {
            var g;
    ...
    Ja.prototype = {
        init: function (a,
            ...
            if (J(a) || a === null)b[e[0]] = a; else if (Ea(a)) {
                if (!d && a.length > f) {
                    c = typeof a[0];
    ...
    R.prototype = {
        ...
        processData: function (a) {
            ...
            if (l && this.sorted && !j && (!i || d > i || this.forceCrop))if (b[d - 1] < n || b[0] > q)b = [], c = []; else if (b[0] < n || b[d - 1] > q)e = this.cropData(this.xData, this.yData, n, q), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        getExtremes: function (a) {
            ...
            d = a.length;
            for (l = 0; l <
            d; l++)if (k = c[l], j = a[l], i = j !== null && j !== y && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k)if (i = j.length)for (; i--;)j[i] !== null && (e[f++] = j[i]); else e[f++] = j;
            this.dataMin = La(e);
            this.dataMax = Ga(e)
        },
        translate: function () {
    ...
    R.prototype.drawDataLabels = function () {
        ...
        a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", j && !h ? "hidden" : "visible", d.zIndex || 6), j && (k.attr({opacity: +h}), h || N(a, "afterAnimate", function () {
            ...
            if (j && !h)e.dataLabel = j.destroy(); else if (h) {
                d = E(g, f);
                v = d.style;
                h = d.rotation;
                p = e.getLabelConfig();
                ...
                if (j)if (r(i))j.attr({text: i}), w = !1; else {
    ...
    u(gb.prototype, {
        showResetZoom: function () {
            ...
            if (d && !e)this.showResetZoom(); else if (!d && Z(e))this.resetZoomButton = e.destroy();
